...
<head>
    ...
    <title>Medical Card Generations System | About Us Page</title>
...
{               ?>      
    ...
    <div class="form-group"> <label for="exampleInputEmail1">Page Description</label> <textarea type="text" name="pagedes" id="pagedes" required="true"class="form-control" rows="8"><?php  echo $row->PageDescription;?></textarea> </div><?php $cnt=$cnt+1;}} ?>
